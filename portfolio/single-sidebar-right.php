        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class( array($has_thumb_class, $has_slider_class, $has_thumb_no_slider) ); ?>>
            ...
            >
                ...
                <?php
                    ...
                    $entryCoverBackground = wp_get_attachment_image_url( get_post_thumbnail_id( $post->ID ), 'entry-cover' );
                    $small_image_url      = wp_get_attachment_image_url( get_post_thumbnail_id( $post->ID), 'featured-small' );
                    
                    $style = ' data-smallimg="' . wpzoom_get_value( $small_image_url, '', null ) . '" data-bigimg="' . wpzoom_get_value( $entryCoverBackground, '', null ) . '"';
                                ...
                                <div class="entry-meta">
                                    ...
                                    <ul>
                                       <?php if ($video_director) { ?>
                                          <li><span class="portfolio_item-director"><?php echo inspiro_get_portfolio_field_label('director'); ?></span> <?php echo $video_director; ?></li>
                                       <?php } ?>

                                       <?php if ($video_year) { ?>
                                          <li><span class="portfolio_item-year"><?php echo inspiro_get_portfolio_field_label('year'); ?></span> <?php echo $video_year; ?></li>
                                       <?php } ?>

                                       <?php if ($video_client) { ?>
                                          <li><span class="portfolio_item-client"><?php echo inspiro_get_portfolio_field_label('client'); ?></span> <?php echo $video_client; ?></li>
                                       <?php } ?>

                                       <?php if ($video_skills) { ?>
                                          <li><span class="portfolio_item-skills"><?php echo inspiro_get_portfolio_field_label('skills'); ?></span> <?php echo nl2br ( do_shortcode($video_skills) );?></li>
                                       <?php } ?>
