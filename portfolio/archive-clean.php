    ...
    <section class="portfolio-archive">
        ...
        <?php if ( $wp_query->have_posts() ) : ?>
            ...
            <div class="inner-wrap portfolio_template_clean">
                ...
                <div <?php echo $portfolio_ajax_atts; ?> class="portfolio-grid col_no_<?php echo $col_number; ?> <?php if ( option::is_on( 'portfolio_whitespace' ) ) { ?> portfolio_with_space<?php } ?><?php echo $always_play_background_video_class; ?>">
